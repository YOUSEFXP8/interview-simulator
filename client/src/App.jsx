  ...
  useEffect(() => {
    ...
    connection.on("EvaluationCompleted", (data) => {
      ...
      window.dispatchEvent(
        new CustomEvent("EvaluationCompleted", { detail: data }),
      );
    });
    connection.on("ResumeProcessed", (data) => {
      console.log("ResumeProcessed:", data);
      window.dispatchEvent(
        new CustomEvent("ResumeProcessed", { detail: data }),
      );
    });
    connection
      .start()
