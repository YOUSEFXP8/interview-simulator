    ...
    <div className="relative flex min-h-screen items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          <Link
            href="/"
            className="font-heading text-3xl font-extrabold tracking-tight text-foreground transition hover:text-primary"
          >
            InterviewAI
          </Link>
        ...
        <div className="mt-8 rounded-2xl border border-border/80 bg-card/40 p-8 shadow-xl backdrop-blur-md">
          ...
          <div className="mt-6 rounded-lg bg-muted/20 border border-border p-4 text-xs text-muted-foreground space-y-1.5">
            ...
            <p>
              Because the database is offline, register a new account or sign in
              with any account registered locally in this browser.
            </p>
          </div>
        </div>
      </div>
