  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute top-[20%] right-[10%] h-[30rem] w-[30rem] rounded-full bg-primary/10 blur-[100px]" />
        <div className="absolute bottom-[20%] left-[10%] h-[35rem] w-[35rem] rounded-full bg-accent/5 blur-[120px]" />
      </div>
